...
- **Data/Hora**: 2025-11-12 14:52:14
- **Versão alvo**: v1 (id_versao=9)
- **Arquivo**: LP001_carga_report_20251112_145214.md
...
Tipo: UnboundLocalError | Detalhe: cannot access local variable 'branch_key' where it is not associated with a value
```