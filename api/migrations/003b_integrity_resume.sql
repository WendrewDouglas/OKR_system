-- ============================================================
-- Migration 003b: Resume — Pendências restantes da 003
-- Data: 2026-02-23
-- ============================================================
-- Fase 1 (charset) e conversões de tipo já foram aplicadas.
-- Este script completa: aprovadores PK, company_style tipos, FKs, duplicata, orphans.
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

-- ============================================================
-- FASE 3 (restante) — aprovadores.id_user VARCHAR→INT + PK
-- ============================================================
...
-- ============================================================
-- FASE 3 (restante) — company_style tipos UNSIGNED→signed
-- ============================================================

-- okr_master_user_id: INT(10) UNSIGNED NULL → INT(11) signed NULL
ALTER TABLE company_style
  MODIFY okr_master_user_id INT(11) NULL DEFAULT NULL;

-- created_by: INT(10) UNSIGNED NOT NULL → INT(11) signed NULL (para SET NULL FK)
ALTER TABLE company_style
...
-- Limpar FK duplicada em iniciativas (iniciativas_ibfk_1 duplica fk_iniciativas_kr)
...
-- 6a) Backup dos orphans
CREATE TABLE IF NOT EXISTS _bak_apontamentos_status_orphans AS
  SELECT a.*
