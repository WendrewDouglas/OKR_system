...
// Limita a lista do ranking à altura do card (chamada no render do ranking e no resize).
// A definição ficava no bloco de script duplicado removido; o script atual só a chamava.
function syncRankHeight(){
  ...
  // como o .rank tem height:100% via CSS, a conta usa a própria altura dele
