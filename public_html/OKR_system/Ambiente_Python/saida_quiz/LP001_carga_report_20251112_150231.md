...
- **Data/Hora**: 2025-11-12 15:02:31
- **Versão alvo**: v1 (id_versao=9)
- **Arquivo**: LP001_carga_report_20251112_150231.md
...
[ PURGE ] Limpando conteúdo anterior do quiz (somente conteúdo; sem runtime)
  ...
  ✓ DELETE overrides | afetadas=0
  - Nenhuma pergunta para remover.
  ✓ DELETE cargo_map | afetadas=0
  ✓ DELETE dominios  | afetadas=0
